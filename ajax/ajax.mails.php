...
//FILTER_SANITIZE_NUMBER_INT Удаляет все символы, кроме цифр и знаков плюса и минуса. //filter_var($name, FILTER_SANITIZE_STRING);
if ( !$is_logged_in )
{	
	if (empty($name)) { 
...
$subject = $subject ? replace_comment('add', preg_replace("/\n/", '', $subject)) : t('Cообщение с сайта.');
